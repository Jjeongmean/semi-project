...
public class Customer {
    //필드
    //GoldCustomer, VIPCustomer 클래스에서 가져다 쓰기 위해 protected 선언(다른 패키지에선 X)
    protected int customerID; //고객 ID
    protected String customerName; // 고객이름
    protected String customerGrade; // 고객등급
    public int bonusPoint; // 적립된 보너스 포인트
    double bonusRatio; // 적립할 보너스 포인트 비율(sliver는 0.01)
    ...
    //보너스 포인트 적립과 가격 리턴
    public int calcPrice(int price) { // 외부에서 사용시 public, 그 반대 private
